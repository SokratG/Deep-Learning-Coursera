...
def is_overlapping(segment_time, previous_segments):
    ...
    for previous_start, previous_end in previous_segments: # @KEEP
        if  ((previous_start >= segment_start and previous_start <= segment_end) or 
            (previous_end >= segment_start and previous_end <= segment_end) or 
            (previous_end >= segment_end and previous_start <= segment_start)):
            overlap = True
            break
    ### END CODE HERE ###
