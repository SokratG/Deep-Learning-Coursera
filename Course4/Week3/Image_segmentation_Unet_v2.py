...
def conv_block(inputs=None, n_filters=32, dropout_prob=0, max_pooling=True):
    ...
    conv = Conv2D(n_filters, # Number of filters
                  ...
                  activation='relu',
                  padding='same',
                  kernel_initializer=tf.keras.initializers.HeNormal(seed=0))(inputs)
    conv = Conv2D(n_filters, # Number of filters
                  3,   # Kernel size
                  activation='relu',
                  padding='same',
                  kernel_initializer=tf.keras.initializers.HeNormal(seed=0))(conv)
    ### END CODE HERE
...
def upsampling_block(expansive_input, contractive_input, n_filters=32):
    ...
    conv = Conv2D(n_filters,   # Number of filters
                 ...
                 activation='relu',
                 padding='same',
                 kernel_initializer=tf.keras.initializers.HeNormal(seed=0))(merge)
    conv = Conv2D(n_filters,  # Number of filters
                 3,   # Kernel size
                 activation='relu',
                 padding='same',
